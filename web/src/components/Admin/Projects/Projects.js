        ...
        <tbody>
          {projects.map((project) => (
            <tr key={project.id}>
              ...
              <td>{truncate(project.ownerEmail)}</td>
              <td>{truncate(project.logo)}</td>
              <td>{truncate(project.shortDescription)}</td>
              <td>{truncate(project.longDescription)}</td>
              <td>{truncate(project.coverImage)}</td>
              <td>{truncate(project.stripeId)}</td>
              <td>{truncate(project.goalAmount)}</td>
              <td>{truncate(project.videoLink)}</td>
              <td>{truncate(project.websiteLink)}</td>
              <td>
